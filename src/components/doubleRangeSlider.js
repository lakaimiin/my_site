...
export default class DoubleRangeSlider extends React.Component {
    state = {
        ...
        offsetSliderWidth: this.props.offsetSliderWidth,
        min: this.props.min,
        max: this.props.max,
    ...
    onMouseMoveMin = (e) => {
        ...
        if( (currentMin >= min) && (currentMin <= (currentMax-minValueBetween))){
            ...
            this.props.setFilterCurrentMin(currentMin)
        }
    }
    ...
    onMouseMoveMax = (e) => {
        ...
        if( (currentMax >= (currentMin + minValueBetween)) && (currentMax <= max)){
            ...
            this.props.setFilterCurrentMax(currentMax)
        }
    }
    ...
    render() {
        ...
        return (
        <div className='double_slider_ranger'>
